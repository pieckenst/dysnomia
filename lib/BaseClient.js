...
class BaseClient extends EventEmitter {
    ...
    guildShardMap = {};
    /**
     * Timestamp of last connect event
     * @type {Number}
     */
    lastConnect = 0;
    /**
     * Last reconnect delay used
     * @type {Number}
     */
    ...
    getChannel(channelID) {
        ...
        if(this.threadGuildMap && this.threadGuildMap[channelID] && this.guilds.get(this.threadGuildMap[channelID])) {
